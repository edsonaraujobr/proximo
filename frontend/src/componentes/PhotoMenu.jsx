...
export function PhotoMenu({linkPhoto, onClickedSettings, onClickedTerms, onClickedSupport, onClickedAbout, onClickedExit }) {
    ...
    return (
        ...
        >        
        <h1 class="text-2xl font-bold text-lime-500 mb-4">Termos de Uso do Sistema do Restaurante Universitário (RU)</h1>
        ...
        <section class="mb-6">
            <h2 class="text-xl font-semibold text-lime-500 border-b-2 border-lime-text-lime-500 pb-1 mb-2">1. Requisitos e Responsabilidades</h2>
            <h3 class="text-lg font-semibold text-lime-500 mt-4">1.1. Para Atendentes</h3>
        ...
        <section class="mb-6">
            <h2 class="text-xl font-semibold text-lime-500 border-b-2 border-lime-text-lime-500 pb-1 mb-2">2. Direitos de Propriedade Intelectual</h2>
        ...
        <section class="mb-6">
            <h2 class="text-xl font-semibold text-lime-500 border-b-2 border-lime-text-lime-500 pb-1 mb-2">3. Proibições</h2>
        ...
        <section class="mb-6">
            <h2 class="text-xl font-semibold text-lime-500 border-b-2 border-lime-text-lime-500 pb-1 mb-2">4. Modificações dos Termos de Uso</h2>
        ...
        <section class="mb-6">
            <h2 class="text-xl font-semibold text-lime-500 border-b-2 border-lime-text-lime-500 pb-1 mb-2">5. Contato</h2>
            <p>Para dúvidas ou questões sobre estes Termos de Uso, entre em contato com proximoru@gmail.com</p>
            
        </section>

        <footer class="bg-lime-text-lime-500 text-white py-4 rounded-b-lg text-center">
